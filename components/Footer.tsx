...
const socialLinks = [
  {
    id: 1,
    title: "Nakul Mahajan's Github Profile",
    link: "https://github.com/Nakul-M",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
  ...
  {
    id: 2,
    title: "Nakul Mahajan's LinkedIn Profile",
    link: "www.linkedin.com/in/nakul-mahajan-6a69b02b9",
    svg: (
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
