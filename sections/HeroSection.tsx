...
const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        AI ENGINEER FULL-STACK DEVELOPER SYSTEMS PROGRAMMER
      </span>
        ...
        <div className="relative w-72 md:w-80 h-80 flex items-center mx-auto">
          <div className="absolute pointer-events-none scale-90 xs:scale-95 mx-auto">
            <Image
              ...
              aria-label="Developer illustration levitating with a laptop"
      ...
      <div className="lg:basis-2/3 z-10 relative">
        ...
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
            I am a Computer Science undergraduate at NIT Srinagar with a strong
            interest in building scalable, high-performance software systems.
          </p>
          <p>
            My work spans full-stack web development, GenAI and RAG-based
            platforms, and system-oriented backend design, with a focus on
            real-world deployment and impact.
          </p>
        </div>

        <LinkButton href="https://wa.me/6006886276">
          Contact me
        </LinkButton>
      </div>
