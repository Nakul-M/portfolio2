        ...
        <RoughNotationGroup>
          ...
          <div className="md:grid grid-rows-5 lg:grid-rows-6 grid-cols-5">
            ...
            <p className="col-start-1 col-end-3 row-start-4 row-end-6 lg:row-start-1 lg:row-end-2 lg:col-start-3 lg:col-end-6 lg:ml-8 lg:mt-auto about-intro">
             I am a Computer Science & Engineering undergraduate at the National Institute of Technology Srinagar, with a strong focus on full-stack web development and AI-driven systems. I have hands-on experience building scalable MERN applications, RESTful APIs, and intelligent solutions for real-world problem statements. My academic foundation, combined with project-based learning and competitive programming, has helped me develop strong problem-solving skills and a practical engineering mindset.
...
const educationInfo = [
  {
    ...
    subTitle: "National Institute of Technology Srinagar | 2022 – Present",
    list: [
      "Core subjects: Data Structures, Algorithms, DBMS, OS, Computer Networks",
      "Actively working on Full-Stack (MERN) and AI-driven projects",
  ...
  },
  {
    ...
    list: [
      ...
      "Built early interest in problem-solving and programming",
    ],
  },
  {
    id: 3,
    title: "Competitive Programming & Technical Achievements",
    subTitle: "Ongoing",
    list: [
      "Knight-level problem solver on LeetCode (Top ~1800 rank)",
      "Strong background in DSA, Graphs, DP, and System Design basics",
    ],
  },
];
